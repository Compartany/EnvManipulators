return {
    ...
    Env_Weapon_1_B_UpgradeDescription = "受到 1 点火焰伤害以获得无限距离跳跃移动和免疫缠绕能力。",
    ...
    Env_Weapon_4_Description = "加载人造环境或增强已有环境。尽可能优先激活锁定灵虫的环境，并尝试终止激活方格内单位的行动。大部分单位都能察觉到危险并避开，但灵虫等部分单位反而会被吸引住并试图靠近。",
    Env_Weapon_4_Upgrade1 = "友军免疫",
    Env_Weapon_4_Upgrade2 = "区域和伤害",
    Env_Weapon_4_A_UpgradeDescription = "尝试阻止锁定友方单位的环境被激活。",
    Env_Weapon_4_B_UpgradeDescription = "根据岛屿进程，所有环境额外锁定 0/1/1/1 方格，人造环境额外造成 0/0/1/1 伤害。"
}

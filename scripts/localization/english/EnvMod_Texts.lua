EnvMod_Texts = {
    ...
    env_passive_description = "Deal %d damage to marked tiles in total. Units are able to detect danger and avoid it.",
    env_passive_basic_description = "Deal 3 basic damage to marked tiles. Units are able to detect danger and avoid it.",
